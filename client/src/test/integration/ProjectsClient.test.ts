...
chai.should();
describe("ProjectsClient (#integration)", () => {
  ...
  it("should get a paged list of projects using top (#integration)", async () => {
  ...
  it("should get a paged list of projects using skip (#integration)", async () => {
  ...
  it("should get a continuous paged list of projects (#integration)", async () => {
    const numberOfProjects = 3;
  ...
  it("should get a list of projects by name (#integration)", async () => {
    const projectList: Project[] = await projectsAccessClient.getAll(accessToken, {
      search: {
